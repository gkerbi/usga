...
/**
 A class that stores parameters for serial ports. These are the
 default parameters to connect to a M1 serial console. 
 */
public class SerialParameters {
	...
	/**
	 Default constructer. Sets parameters to no port, 19200 baud, no flow 
	 control, 8 data bits, 1 stop bit, no parity.
	 */
	public SerialParameters() {
		this("", 19200, SerialPort.FLOWCONTROL_NONE, //$NON-NLS-1$
	...
	public void setParity(String parity) {
		...
		if (parity.equals("Mark")) { //$NON-NLS-1$
			this.parity = SerialPort.PARITY_MARK;
		}
		if (parity.equals("Space")) { //$NON-NLS-1$
